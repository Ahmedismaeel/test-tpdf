...
describe('Document e2e test', () => {
  ...
  it('should load Documents', async () => {
    ...
    expect(await documentComponentsPage.getTitle()).to.eq('testtpdfApp.document.home.title');
  });
  ...
  it('should load create Document page', async () => {
    ...
    expect(await documentUpdatePage.getPageTitle()).to.eq('testtpdfApp.document.home.createOrEditLabel');
  ...
  /*  it('should delete last Document', async () => {
        ...
        expect(await documentDeleteDialog.getDialogTitle())
            .to.eq('testtpdfApp.document.delete.question');
