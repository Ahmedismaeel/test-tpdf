...
import {
  ContentComponentsPage,
  /* ContentDeleteDialog,
   */ ContentUpdatePage
} from './content.page-object';
...
describe('Content e2e test', () => {
  ...
  it('should load Contents', async () => {
    ...
    expect(await contentComponentsPage.getTitle()).to.eq('testtpdfApp.content.home.title');
  });
  ...
  it('should load create Content page', async () => {
    ...
    expect(await contentUpdatePage.getPageTitle()).to.eq('testtpdfApp.content.home.createOrEditLabel');
  ...
  /*  it('should delete last Content', async () => {
        ...
        expect(await contentDeleteDialog.getDialogTitle())
            .to.eq('testtpdfApp.content.delete.question');
